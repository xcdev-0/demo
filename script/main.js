...
async function loginAndCall(clientB) {
...
async function loginAndGetPendingRequests(clientA) {
...
async function main() {
  await signupUsers();
  await loginAndCall(clientB);
  await loginAndGetPendingRequests(clientA);
